...
public class QueryParser extends Parser {
	...
	public static class NumberTermContext extends TermContext {
		public TerminalNode TERM_NUMBER() { return getToken(QueryParser.TERM_NUMBER, 0); }
	...
	public static class FieldTermContext extends TermContext {
		public TerminalNode TERM_FIELD() { return getToken(QueryParser.TERM_FIELD, 0); }
		public FieldTermContext(TermContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QueryVisitor ) return ((QueryVisitor<? extends T>)visitor).visitFieldTerm(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class StringTermContext extends TermContext {
		public TerminalNode TERM_STRING() { return getToken(QueryParser.TERM_STRING, 0); }
