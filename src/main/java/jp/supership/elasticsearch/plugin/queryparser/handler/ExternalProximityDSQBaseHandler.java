 ...
 * @since  1.0
 */
abstract class ExternalProximityDSQBaseHandler extends ExternalQueryBaseVisitor<ProximityArchetype> implements TreeHandler, Initializable {
    /** Holds ES logger. */
     ...
     */
    @Override
    public ProximityArchetype visitExpression(ExternalQueryParser.ExpressionContext context) {
	try {
	    int operator = -1;
	    if (context.CONJUNCTION_OR() != null) {
		operator = ExternalQueryParser.CONJUNCTION_OR;
     ...
     */
    @Override
    public ProximityArchetype visitClause(ExternalQueryParser.ClauseContext context) {
	try {
     ...
     */
    @Override
    public ProximityArchetype visitField(ExternalQueryParser.FieldContext context) {
	try {
     ...
     */
    @Override
    public ProximityArchetype visitQuotedTerm(ExternalQueryParser.QuotedTermContext context) {
	try {
