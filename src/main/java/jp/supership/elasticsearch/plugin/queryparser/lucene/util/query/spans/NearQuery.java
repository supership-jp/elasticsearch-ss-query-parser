 ...
 * @since  1.0
 */
public class NearQuery extends ProximityQuery {
    /**
     * Constructor.
     */
    public NearQuery(Collection<ArgumentedQuery> queries, boolean infixed, int slop, int operator, boolean inOrder) {
